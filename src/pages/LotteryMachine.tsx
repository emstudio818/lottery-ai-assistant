  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="flex items-center gap-2 md:gap-3">
        <Trophy className="text-gold-400 w-6 h-6 md:w-8 md:h-8" />
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-white">搖獎機</h1>
          <p className="text-sm md:text-base text-gray-400">手動模擬大樂透開獎</p>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="text-center mb-6 md:mb-8">
          <div className="inline-block relative">
            {/* 搖獎機外觀 */}
            <div className="w-60 h-60 md:w-80 md:h-80 rounded-full bg-gradient-to-br from-gray-800 via-gray-900 to-black border-4 border-gray-700 shadow-2xl flex items-center justify-center relative overflow-hidden">
              {/* 閃光效果 */}
              {isSpinning && (
                <>
              ...
              <div className="text-center z-10">
                <Sparkles className={`mx-auto mb-2 md:mb-4 ${isSpinning ? 'text-yellow-400 animate-spin' : 'text-gray-600'}`} size={36} />
        ...
        <div className="mb-6 md:mb-8">
          <h2 className="text-lg md:text-xl font-semibold text-white mb-3 md:mb-4 text-center">開獎號碼</h2>
          <div className="flex items-center justify-center gap-2 md:gap-3 flex-wrap">
            {numbers.map((num, idx) => (
              <div
                key={idx}
                className={`
                  w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center text-xl md:text-2xl font-bold border-4
            ...
            <div className="w-6 md:w-8 flex items-center justify-center text-gray-500 font-bold text-lg md:text-xl">+</div>
          ...
          <div className="text-center text-sm md:text-base text-gray-400 mt-2">
        ...
        <div className="flex items-center justify-center gap-3 md:gap-4 flex-wrap">
          <button
            ...
            disabled={isSpinning}
            className={`
              flex items-center gap-2 px-6 py-3 md:px-8 md:py-4 rounded-xl font-bold text-base md:text-lg transition-all
              ${isSpinning 
          ...
          <button
            onClick={reset}
            className="flex items-center gap-2 px-5 py-3 md:px-6 md:py-4 rounded-xl font-bold text-base md:text-lg bg-gray-700 text-white hover:bg-gray-600 transition-all shadow-lg active:scale-95"
          >
        ...
        {/* 歷史記錄（這次的結果） */}
        {stage === 7 && (
          <div className="mt-6 md:mt-8 p-4 bg-gray-800/50 rounded-xl border border-gray-700">
            <h3 className="text-base md:text-lg font-semibold text-white mb-3">本次開獎結果</h3>
            <div className="flex items-center justify-center gap-1 md:gap-2 flex-wrap">
              ...
              <div className="w-6 md:w-8 flex items-center justify-center text-gray-500 font-bold text-sm md:text-base">+</div>
      ...
      {/* 使用說明 */}
      <div className="card">
        <h3 className="text-base md:text-lg font-semibold text-white mb-2 md:mb-3">使用說明</h3>
        <ul className="text-sm md:text-base text-gray-400 space-y-1 md:space-y-2">
